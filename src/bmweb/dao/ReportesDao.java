...
public class ReportesDao implements IReportesDao {
	 ...
	 * @return
	 */
	public List ejecutarReporte(String reporteId){
		...
		ReporteGenericoMappingQuery rgmp = new ReporteGenericoMappingQuery(dataSource);
	...
	class ReporteGenericoMappingQuery extends MappingSqlQuery {
		...
		public ReporteGenericoMappingQuery(DataSource ds) {
